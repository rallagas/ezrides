...
--
-- Dumping data for table `angkas_bookings`
--

INSERT INTO `angkas_bookings` (`angkas_booking_id`, `angkas_booking_reference`, `shop_order_reference_number`, `shop_cost`, `transaction_category_id`, `user_id`, `angkas_rider_user_id`, `form_from_dest_name`, `user_currentLoc_lat`, `user_currentLoc_long`, `form_to_dest_name`, `formToDest_long`, `formToDest_lat`, `form_ETA_duration`, `form_TotalDistance`, `form_Est_Cost`, `date_booked`, `booking_status`, `payment_status`, `payment_id`, `rating`) VALUES
(136, 'GRXF8B1O3H3', 'SHOPN3J5F0Z7', '42.87', 6, 31, 32, '6GRQ+7HM Ligao, Albay', '13.24', '123.54', '8CHP+HC Polangui, Albay, Philippines', '123.44', '13.33', '23.00', '16.83', '198.30', '2024-11-26 22:56:24', 'A', 'C', NULL, '3'),
(139, 'ANGQ5H3V4M6', NULL, NULL, 2, 31, NULL, '8CHP+HC Polangui, Albay, Philippines', '13.3288808', '123.4360541', 'XentroMall Polangui', '13.288923', '123.4888707', '9.00', '8.00', '110.00', '2024-11-27 07:59:11', 'P', 'P', NULL, '3');
...
INSERT INTO `items_inventory` (`items_inventory_id`, `item_reference_id`, `item_description`, `vendor_id`, `txn_category_id`, `item_price`, `date_added`) VALUES
(1, 0, 'Birth Certificate', 1, 5, 360, '2024-09-17 18:37:49'),
(2, 0, 'CENOMAR', 1, 5, 360, '2024-09-17 18:40:02'),
(3, 0, 'Wallet Top Up - 100', 2, 7, 100, '2024-09-17 18:40:52'),
(4, 0, 'Wallet Top Up - 200', 2, 7, 200, '2024-09-17 18:41:11'),
(5, 0, 'Wallet Top Up - 500', 2, 7, 500, '2024-09-17 18:41:51'),
(6, 0, 'Generic - Medicine Pabili - South Star Drug', 4, 4, 50, '2024-09-17 18:44:32'),
(7, 0, 'Branded - Medicine Pabili - South Star Drug', 4, 4, 50, '2024-09-17 18:46:43'),
(8, 0, 'Generic - Medicine Pabili - Mercury Drug', 3, 4, 50, '2024-09-17 18:47:09'),
(9, 2, 'RENTAL:2:Toyota:2000.00:XXX 124', 8, 1, 2000, '2024-10-02 19:12:56'),
(10, 1, 'RENTAL:1:Volvo:0.00:XXX 123', 8, 1, 2500, '2024-10-02 19:23:12'),
(14, 15, 'RENTAL:15:Isuzu Elf:600.00:GHI-3456', 8, 1, 600, '2024-10-04 13:07:49'),
(15, 12, 'RENTAL:12:Toyota Corolla:200.00:ABC-1234', 8, 1, 200, '2024-10-04 13:08:33'),
(16, 13, 'RENTAL:13:Honda CBR1000RR:100.00:XYZ-5678', 8, 1, 100, '2024-10-04 13:08:35'),
(17, 14, 'RENTAL:14:Ford Transit:400.00:DEF-9012', 8, 1, 400, '2024-10-04 13:08:37'),
(18, 16, 'RENTAL:16:Ford Explorer:300.00:JKL-7890', 8, 1, 300, '2024-10-04 13:08:38'),
(19, 17, 'RENTAL:17:Toyota Hilux:500.00:MNO-5678', 8, 1, 500, '2024-10-04 13:08:39'),
(20, 18, 'RENTAL:18:Tesla Model 3:250.00:PQR-1234', 8, 1, 250, '2024-10-04 13:08:40'),
(21, 19, 'RENTAL:19:Toyota Prius:200.00:STU-5678', 8, 1, 200, '2024-10-04 13:08:43'),
(22, 20, 'RENTAL:20:Honda Scoopy:60.00:VWX-1234', 8, 1, 60, '2024-10-04 13:10:03'),
(23, 21, 'RENTAL:21:Giant Escape:20.00:YZX-5678', 8, 1, 20, '2024-10-04 13:10:05');
...
INSERT INTO `shop_orders` (`order_id`, `shop_order_ref_num`, `voucher_code`, `Shipping_fee`, `shipping_name`, `shipping_address`, `shipping_address_coor`, `shipping_phone`, `user_id`, `rider_id`, `item_id`, `quantity`, `amount_to_pay`, `order_date`, `delivery_status`, `payment_status`, `order_state_ind`, `order_special_instructions`) VALUES
(1161, 'SHOPN3J5F0Z7', NULL, NULL, 'Dela, Juan, C', '8CHP+HC Polangui, Albay, Philippines', '13.3288805,123.4360564', '09985518206', 31, NULL, 6, 5, '8.95', '2024-11-26 22:56:11', 'P', 'C', 'O', NULL),
(1166, 'SHOPN3J5F0Z7', NULL, NULL, 'Dela, Juan, C', '8CHP+HC Polangui, Albay, Philippines', '13.3288805,123.4360564', '09985518206', 31, NULL, 5, 4, '23.96', '2024-11-26 22:56:13', 'P', 'C', 'O', NULL),
(1170, 'SHOPN3J5F0Z7', NULL, NULL, 'Dela, Juan, C', '8CHP+HC Polangui, Albay, Philippines', '13.3288805,123.4360564', '09985518206', 31, NULL, 4, 4, '9.96', '2024-11-26 22:56:14', 'P', 'C', 'O', NULL),
(1174, 'SHOPN1V3B6O5', NULL, NULL, 'Dela, Juan, C', '8CHP+HC Polangui, Albay, Philippines', '13.3288805,123.4360564', '09985518206', 31, NULL, 6, 4, '7.16', '2024-11-26 23:21:18', 'P', 'C', 'O', NULL),
(1178, 'SHOPG0A1U2Y9', NULL, NULL, 'Dela, Juan, C', '8CHP+HC Polangui, Albay, Philippines', '13.3288808,123.4360541', '09985518206', 31, NULL, 2, 2, '6.98', '2024-11-27 00:04:44', 'P', 'C', 'O', NULL),
(1179, 'SHOPG0A1U2Y9', NULL, NULL, 'Dela, Juan, C', '8CHP+HC Polangui, Albay, Philippines', '13.3288808,123.4360541', '09985518206', 31, NULL, 3, 1, '1.99', '2024-11-27 06:05:53', 'P', 'C', 'O', NULL),
(1181, 'SHOPG0A1U2Y9', NULL, NULL, 'Dela, Juan, C', '8CHP+HC Polangui, Albay, Philippines', '13.3288808,123.4360541', '09985518206', 31, NULL, 5, 1, '5.99', '2024-11-27 06:05:55', 'P', 'C', 'O', NULL),
(1182, 'SHOPG0A1U2Y9', NULL, NULL, 'Dela, Juan, C', '8CHP+HC Polangui, Albay, Philippines', '13.3288808,123.4360541', '09985518206', 31, NULL, 4, 1, '2.49', '2024-11-27 06:05:58', 'P', 'C', 'O', NULL),
(1183, 'SHOPG0A1U2Y9', NULL, NULL, 'Dela, Juan, C', '8CHP+HC Polangui, Albay, Philippines', '13.3288808,123.4360541', '09985518206', 31, NULL, 6, 1, '1.79', '2024-11-27 06:05:59', 'P', 'C', 'O', NULL),
(1184, 'SHOPG0A1U2Y9', NULL, NULL, 'Dela, Juan, C', '8CHP+HC Polangui, Albay, Philippines', '13.3288808,123.4360541', '09985518206', 31, NULL, 9, 1, '4.49', '2024-11-27 06:06:01', 'P', 'C', 'O', NULL),
(1185, 'SHOPG0A1U2Y9', NULL, NULL, 'Dela, Juan, C', '8CHP+HC Polangui, Albay, Philippines', '13.3288808,123.4360541', '09985518206', 31, NULL, 7, 1, '6.99', '2024-11-27 06:06:02', 'P', 'C', 'O', NULL);
...
(1, 'rent', 'RNT', '_car_rental.php', '', 'Car Rental', 'A', 'car', 'rent', '_car_rental.js'),
(2, 'angkas', 'ANG', '_angkas.php', '', 'Angkas', 'A', 'moped', 'angkas', ''),
...
INSERT INTO `user_wallet` (`user_wallet_id`, `user_id`, `payTo`, `payFrom`, `wallet_txn_amt`, `txn_type_id`, `wallet_action`, `payment_type`, `reference_number`, `wallet_txn_status`, `wallet_txn_start_ts`) VALUES
(00000000224, 31, NULL, NULL, '3000.00', 7, 'Top Up Wallet', 'T', 'TUPP4Q2U7P0', 'C', '2024-11-27 06:07:34'),
(00000000225, 31, NULL, 31, '-30.72', 6, 'Made Payment for SHOPG0A1U2Y9', 'S', 'SHOPG0A1U2Y9', 'C', '2024-11-27 06:07:43'),
(00000000226, 31, NULL, 31, '-198.30', 6, 'Made Payment for GRXX5V6T1Q2', 'R', 'GRXX5V6T1Q2', 'C', '2024-11-27 06:07:43'),
(00000000227, NULL, NULL, 31, '138.81', 6, 'Made Payment from 31', 'R', 'GRXX5V6T1Q2', 'C', '2024-11-27 06:07:43'),
(00000000228, NULL, -99, 31, '59.49', 6, 'Made Payment to Admin', 'R', 'GRXX5V6T1Q2', 'C', '2024-11-27 06:07:43');
...
INSERT INTO `vehicle` (`vehicle_id`, `vehicle_type`, `vehicle_plate_no`, `vehicle_color`, `vehicle_model`, `vehicle_img`, `vehicle_owner_id`, `vehicle_price_rate_per_hr`, `vehicle_price_rate_per_day`, `vehicle_price_rate_per_km`, `vehicle_txn_type`) VALUES
...
--
ALTER TABLE `angkas_bookings`
  MODIFY `angkas_booking_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=140;
...
--
ALTER TABLE `shop_orders`
  MODIFY `order_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1186;
...
--
ALTER TABLE `user_wallet`
  MODIFY `user_wallet_id` bigint(11) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=229;
