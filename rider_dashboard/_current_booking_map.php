...
<div class="modal fade" id="dropOffModal" tabindex="-1" aria-labelledby="dropOffModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBWi3uSAaNEmBLrAdLt--kMWsoN4lKm9Hs&libraries=places,geometry,marker&callback=initMap&loading=async"></script>
