        ...
        <div class="row px-2">
                ...
                <div class="collapse card shadow border-0" id="convertEarnings">
                    ...
                    <div class="card-body">
                        <form id="formConvert">
                            ...
                            <input name="ConvertAmount" type="number" class="shadow form-control mb-3" placeholder="Amount"
                                max="<?php echo $earnings;?>" required>
            ...
            <div class="col-12">
                <div class="collapse card shadow border-0" id="cashOut">
                    ...
                    <div class="card-body">
                        <form id="formCashOut" enctype="multipart/form-data">
                           <div class="container-fluid">
                               <div class="row">
                                  <div class="col-12">
                                        <input name="CashOutAmount" type="number" class="border-1 border-secondary shadow form-control mb-3" placeholder="Amount" max="<?php echo $earnings;?>" required>          
                                  </div>
                                   <div class="col-6">
                                        <label for="receivePaymentQR" class="form-label w-100 h-100 text-center align-center shadow btn btn-outline-secondary">Upload GCASH QR to Receive</label>
                                        <input hidden type="file" class="form-file" name="receivePaymentQR" id="receivePaymentQR">           
                                   </div>
                                   <div class="col-1 pt-4">
                                        <i class="align-middle text-center">OR</i>
                                   </div>
                                   <div class="col-5">
                                       <input name="GCashAccountNumber" type="text" class="form-control mb-3" placeholder="GCASH Account Number">
                                       <input name="GCashAccountName" type="text" class="form-control mb-3" placeholder="GCASH Account Name">
                                   </div>
                                   <div class="col-12 text-center">
                                        <button class="mt-3 btn btn-primary btnCashOut shadow">Submit Request
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                                class="bi bi-rocket-takeoff" viewBox="0 0 16 16">
                                                <path
                                                    d="M9.752 6.193c.599.6 1.73.437 2.528-.362s.96-1.932.362-2.531c-.599-.6-1.73-.438-2.528.361-.798.8-.96 1.933-.362 2.532" />
