        ...
        <div class="MyEarnings row">
            <div class="col-12 px-5">
                ...
                <div class=" container-fluid" id="myTabContent">
                    <div class="row" id="wallet-tab-pane" role="tabpanel" aria-labelledby="wallet-tab" tabindex="0">
                        ...
                        <div class="container-fluid mt-3">
                            <div class="row">
                                <div class="col-6 mb-3">
                                    <div class="card shadow">
                                        <div class="card-body">
                                            ...
                                            <span class="card-title text-secondary">WALLET BALANCE
                                                <button class="btn btn-link text-decoration-none" data-bs-toggle="modal"
                                                    data-bs-target="#topUpModal">CASH IN</button>
                                            ...
                                            <?php 
                                                ...
                                                ?>
                                            <p class="walletbalance card-text fs-3 fw-bold">
                                ...
                                <div class="col-6 mb-3">
                                    <div class="card shadow">
                                        <div class="card-body">
                                            <span class="card-title text-secondary">EARNINGS
                                                <a class="btn btn-link text-decoration-none" data-bs-toggle="collapse"
                                                    href="#cashOut" role="button" aria-expanded="false"
                                            ...
                                            <?php 
                                                ...
                                                ?>
                                            <p class="earnings card-text fs-3 fw-bold">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="card shadow">
                                <div class="card-body" id="rideHistory">
