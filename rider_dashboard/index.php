...
//$myBooking = select_data( "angkas_bookings", "angkas_rider_user_id = {$rider_logged} AND ");
//if(!empty($myBooking)){
        ...
        <div class="MyEarnings row">
            <div class="col-12 px-5">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="claims-tab" data-bs-toggle="tab"
                            data-bs-target="#claims-tab-pane" type="button" role="tab" aria-controls="claims-tab-pane"
                            aria-selected="false">Claims</button>
                    </li>

                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="bookings-tab" data-bs-toggle="tab"
                            data-bs-target="#bookings-tab-pane" type="button" role="tab" aria-controls="bookings-tab-pane"
                    ...
                    <div class="tab-pane fade show active" id="wallet-tab-pane" role="tabpanel" aria-labelledby="wallet-tab" tabindex="0">
                        ...
                        <div class="card mt-3">
                            <div class="card-body">
                                ...
                                <?php $wallet = query("SELECT SUM( CASE WHEN ? = payTo THEN wallet_txn_amt * -1 
                                ...
                                <p class="walletbalance card-text display-4">
                                    <?php echo (($wallet[0]['balance']) ?? 0.00)  ;?>
                                </p>

                            </div>
                        </div>
                    </div>
                    <div class="tab-pane fade" id="claims-tab-pane" role="tabpanel" aria-labelledby="claims-tab" tabindex="0">...</div>
