...
<!--              <button type="button" class="loadPage btn btn-outline-secondary" load-page="_items_control.php" load-into="controlDashboard">Merchant Management</button>-->
                   
                    <a href="?page=_items_control" class="btn btn-outline-secondary">Items Management</a>
            </div>
      </div>
    </div>
  </div>
