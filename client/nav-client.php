<nav class="navbar navbar-dark bg-opacity-75 bg-dark sticky-top">
    <div class="container-fluid clear-fix">
        ...
        <button id="appMenuBtn" class="border-0 navbar-brand btn btn-outline-light bg-purple mt-1 pb-1" type="button"
        ...
        <button class="navbar-toggler px-1 bg-purple" type="button" data-bs-toggle="offcanvas"
