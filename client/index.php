            ...
            <div class="col-lg-12">
                <nav class="navbar navbar-expand-lg bg-body-secondary">
                    <div class="container-fluid">
                        <button class="py-2 navbar-toggler bg-purple text-light btn-outline-secondary" type="button" data-bs-toggle="collapse" data-bs-target="#mainMenu" aria-controls="mainMenu" aria-expanded="false" aria-label="toggle menu">
...
<!--          another button to show restaurant finder-->
