...
>>>>>>> Stashed changes
            ...
            <h1 class="fw-bold display-6 m-5"> Welcome!
        ...
        <div class="col-12 col-lg-6">
            <div class="container-fluid">
                <div class="row gx-2">
                     ...
                     if($_SESSION['t_user_type'] == 'C'){
                         foreach($txn_cats as $tcat){
                             appButton($tcat['icon_class']
                                         ...
                                         , $tcat['page_action']
                                         , $tcat['txn_category_name']
                                     );
                         }
                                                            }?>
                    <div class="col-lg-3 col-md-2 col-sm-2 col-3 p-0 text-center">
                        <a href="index.php?page=shop&txn_cat=6&merchant=13" class="btn btn-outline-light bg-purple shadow rounded-4">
                    ...
                    <div class="col-lg-3 col-md-2 col-sm-2 col-3 p-0 text-center">
                        <a href="index.php?page=shop&txn_cat=6&merchant=11" class="btn btn-outline-light bg-purple shadow rounded-4">
                    ...
                    <div class="col-lg-3 col-md-2 col-sm-2 col-3 p-0 text-center">
                        <a href="index.php?page=shop&txn_cat=6&merchant=1" class="btn btn-outline-light bg-purple shadow rounded-4">
                    ...
                    <div class="col-lg-3 col-md-2 col-sm-2 col-3 p-0 text-center">
                        <a href="index.php?page=shop&txn_cat=6&merchant=12" class="btn btn-outline-light bg-purple shadow rounded-4">
...
<script src="https://cdn.jsdelivr.net/npm/@coreui/coreui-pro@5.7.0/dist/js/coreui.bundle.min.js" integrity="sha384-kwU8DU7Bx4h5xZtJ61pZ2SANPo2ukmbAwBd/1e5almQqVbLuRci4qtalMECfu9O6" crossorigin="anonymous">
</script>
