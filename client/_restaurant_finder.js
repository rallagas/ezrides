...
const ND_MARKER_ICONS_BY_TYPE = {
  ...
  'grocery_or_supermarket': 'local_grocery_store',
     ...
     // Additional icons for new place types
  'convenience_store': 'store',  // Icon for convenience stores
    'pharmacy': 'local_pharmacy'
//  'supermarket': 'shopping_cart', // Icon for supermarkets
//  'store': 'storefront'  // Generic store icon
};
