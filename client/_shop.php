    ...
    <div class="container-fluid d-none" id="shopHistory">
        ...
        <ul class="nav nav-pills nav-justified justify-content-center" id="shopHistoryNav" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="shoplist-tab" data-bs-toggle="tab" 
                        data-bs-target="#shop-list-pane" type="button" role="tab" 
                        aria-controls="shop-list-pane" aria-selected="true">
                            <span class="small fw-bold">Unpaid Shop List</span>
                </button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="pnd-tab" data-bs-toggle="tab"
                        data-bs-target="#paid-no-driver-pane" type="button" role="tab" 
                        aria-controls="paid-no-driver-pane" aria-selected="false">
                        <span class="small fw-bold">Paid No Rider</span>
                </button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="pwd-tab" data-bs-toggle="tab" 
                       data-bs-target="#paid-with-driver-pane" type="button" role="tab" 
                       aria-controls="paid-with-driver-pane" aria-selected="false">
                       <span class="small fw-bold">Paid With Rider</span>
                </button>
            </li>
        </ul>
        <div class="tab-content px-2" id="shopHistoryTabs">
            <div class="tab-pane fade show active" id="shop-list-pane" role="tabpanel" aria-labelledby="shoplist-tab" tabindex="0">1...</div>
            <div class="tab-pane fade" id="paid-no-driver-pane" role="tabpanel" aria-labelledby="pnd-tab" tabindex="0">..2.</div>
            <div class="tab-pane fade" id="paid-with-driver-pane" role="tabpanel" aria-labelledby="pwd-tab" tabindex="0">.3..</div>
        </div>
    </div>
<!-- Main Shop -->

   <div class="bg-dark bg-opacity-75 py-2 position-fixed bottom-0 end-0 z-3">
                <!-- Button to Show Cart Items -->

                <button class="d-none shadow btn btn-warning border-2 border-light btn-lg position-relative mx-1 btn-checkout float-end"
                ...
                <button id="ShowCartItems" class="shadow btn btn-warning btn-lg position-relative float-end mx-1"
                    data-bs-toggle="collapse" data-bs-target="#CartItems" aria-expanded="false"
                ...
                <button class="HideOrderHistory toggleBtnOrderHist d-none shadow btn btn-lg btn-primary position-relative mx-1 float-end">
                ...
                <button class="ShowOrderHistory toggleBtnOrderHist shadow btn btn-lg btn-primary position-relative mx-1 float-end">
                    <span class="MyShopListCountBadge position-absolute  z-3 top-0 start-100 translate-middle badge rounded-pill bg-danger"></span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
    ...
    <div class="container-fluid" id="MainShop">
        ...
        <div class="row gx-1">
            <div class="col-6 clear-fix px-2">
                <input type="text" class="rounded-4 form-control form-control-sm d-flex w-100" id="SearhItems"
                    placeholder="Search Items">
            </div>
         
            <div class="col-12">
                <div class="collapse CartItems row gx-1 py-2 ps-2 bg-success small border border-5 border-start-0 border-end-0 border-bottom-0 border-success bg-opacity-75" id="CartItems">
                    No Cart Items
                </div>
            </div>
            <div class="col-12">
                            ...
                            <form id="formPlaceOrder">
                                <div class="modal-body overflow-y-scroll" style="height:70vh">
                                    <input type="text" readonly class="form-control text-secondary fw-bold border-0"
                                        ...
                                        value="<?php echo gen_book_ref_num(8, "SHOP"); ?>">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <div class="input-group input-group-sm border rounded border-secondary border-opacity-50 mb-2">
                                            <span class="input-group-text small border-0">Distance</span>
                                            <input type="text" class=" border-0 form-control form-control-sm" id="formDistanceKM" required>
                                            <span class=" border-0 small input-group-text">KM</span>
                                        </div>
                                        <div class="input-group input-group-sm border rounded border-secondary border-opacity-50  mb-2">
                                            <span class="input-group-text small border-0">Est. Time to Complete
                                                Route</span>
                                            <input type="text" class="form-control form-control-sm  border-0" id="formETA" required>
                                            <span class="input-group-text small  border-0">Mins</span>
                                        </div>
                                        <div class="input-group input-group-sm border rounded border-secondary border-opacity-50  mb-2">
                                            <span class="input-group-text border-0">Delivery Cost (Php)</span>
                                            <Input type="text" class="border-0 form-control form-control-sm" id="formEstimatedCost" required />
                                        </div>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button id="placeOrderBtn" type="submit" class="btn btn-primary" data-bs-target="#PaymentModal"
                                        data-bs-toggle="modal">Place Order</button>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <div class="modal fade" id="PaymentModal" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2"
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button class="btn btn-outline-success" id="PayNowBtn">Pay Now</button>
        ...
        <div class="row">
            <nav aria-label="Page navigation" class="shop-navigation">
