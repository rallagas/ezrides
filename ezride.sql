...
--
-- Host: localhost
-- Generation Time: May 14, 2025 at 05:44 AM
...
CREATE TABLE `angkas_bookings` (
  ...
  `additionalfile` varchar(100) DEFAULT NULL
...
--
-- Dumping data for table `customerSuggestions`
--

INSERT INTO `customerSuggestions` (`cs_id`, `emailadd`, `cus_id`, `message`, `rate`, `photo`, `approved`) VALUES
(2, 'test@gmail.com', NULL, 'Easy to contact, safe, and very affordable! Recommended for those na need ng service and urgent matters.', 5, NULL, 1),
(3, 'test@gmail.com', NULL, 'Highly Recommended si EZ Rides. Trustworthy at maaasahan. madaling katransact at mabait ang mga rider. salamat EZ Rides til next transaction.', 5, NULL, 1),
(5, NULL, NULL, 'Napakaganda ng services', 5, NULL, 1),
(6, 'test@gmail.com', NULL, 'Madali na lng mamalengke. thanks EZ Rides', 5, 'comment_678d985e08e805.10237230.jpeg', 1),
(7, 'test@gmail.com', NULL, 'Bilis ng Delivery', 3, 'comment_678da0ba895484.97320918.jpg', 1);
...
CREATE TABLE `items_inventory` (
  ...
  `vendor_id` int(11) NOT NULL DEFAULT 8 COMMENT 'associated with vendors inside the app',
  `txn_category_id` int(11) NOT NULL,
...
CREATE TABLE `shop_items` (
  ...
  `saleIndicator` varchar(1) DEFAULT NULL,
...
INSERT INTO `shop_items` (`item_id`, `item_name`, `price`, `saleDiscount`, `saleIndicator`, `merchant_id`, `category`, `quantity`, `item_img`, `date_added`, `item_status`) VALUES
(1, 'Big Mac', '165.00', NULL, '', 12, 1, 1000, '67911d24c6e1b_1737307774697.jpg', '2025-01-22 08:30:28', 'A'),
(2, 'Burger Mcdo', '45.00', NULL, '', 12, 1, 1000, '67911d4c02494_1737307774694.jpg', '2025-01-22 08:31:08', 'A'),
(3, 'Quarter Pounder with Cheese', '165.00', NULL, '', 12, 1, 1000, '67911d711aaf9_1737307774690.jpg', '2025-01-22 08:31:45', 'A'),
(4, 'Cheeseburger', '80.00', NULL, '', 12, 1, 1000, '67911d9bf225a_1737307774686.jpg', '2025-01-22 08:32:27', 'A'),
(5, 'Double Cheeseburger', '135.00', NULL, '', 12, 1, 1000, '67911e7695c43_1737307774682.jpg', '2025-01-22 08:36:06', 'A'),
(6, 'McCrispy Chicken Sandwich', '62.00', NULL, '', 12, 1, 1000, '67911ee08a528_1737307774678.jpg', '2025-01-22 08:37:52', 'A'),
(7, 'McChicken Sandwich', '100.00', NULL, '', 12, 1, 1000, '67911f38984e9_1737307774673.jpg', '2025-01-22 08:39:20', 'A'),
(8, '1pc Chicken Mcdo with Spaghetti', '202.00', NULL, '', 12, 1, 1000, '67911f5fc81d5_1737307815201.jpg', '2025-01-22 08:39:59', 'A'),
(9, '2 pc. Chicken Mcdo with rice', '235.00', NULL, '', 12, 1, 1000, '67911f83ad191_1737307815196.jpg', '2025-01-22 08:40:35', 'A'),
(10, '1pc Chicken Mcdo with rice', '151.00', NULL, '', 12, 1, 1000, '67911fa7063f7_1737307815192.jpg', '2025-01-22 08:41:11', 'A'),
(11, 'Mcrispy Chicken Fillet with Rice', '148.00', NULL, '', 12, 1, 1000, '67911fdd330e0_1737307815186.jpg', '2025-01-22 08:42:05', 'A'),
(12, '6pcs. Chicken Nuggets with Medium Meal', '198.00', NULL, '', 12, 1, 1000, '6791200a40aea_1737307815179.jpg', '2025-01-22 08:42:50', 'A'),
(13, 'Crispy Chicken Fillet with extra rice', '99.00', NULL, '', 12, 1, 1000, '679120a3c3d44_1737307311768.jpg', '2025-01-22 08:45:23', 'A'),
(14, 'Crispy Chicken with extra rice', '99.00', NULL, '', 12, 1, 1000, '679120c827ecf_1737307311773.jpg', '2025-01-22 08:46:00', 'A'),
(15, 'Bioflu', '120.00', NULL, '', 11, 1, 1000, '679120e18da38_bioflue.jpg', '2025-01-22 08:46:25', 'A'),
(16, 'Biogesic', '125.00', NULL, '', 11, 1, 1000, '679120f6c7da3_biogesic.jpg', '2025-01-22 08:46:46', 'A'),
(17, 'Neozep', '130.00', NULL, '', 11, 1, 1000, '6791210c0e636_neozep.png', '2025-01-22 08:47:08', 'A'),
(18, 'Alaxan', '130.00', NULL, '', 11, 1, 1000, '67912121dacca_alaxan.jpg', '2025-01-22 08:47:29', 'A'),
(19, 'Decolgen', '130.00', NULL, '', 11, 1, 1000, '679121392f7e5_decolgen.jpg', '2025-01-22 08:47:53', 'A'),
(20, 'Frabelle Yummy Pack', '150.00', NULL, '', 1, 1, 1000, '67912163985ef_frabelle.jpg', '2025-01-22 08:48:35', 'A'),
(21, 'Bounty Fresh Chicken', '250.00', NULL, '', 1, 1, 1000, '679121bc951a6_TGM_Ecomm_Chicken_Slide-2_03-Chicken-Breast-1.jpg', '2025-01-22 08:50:04', 'A'),
(22, 'Fresh Eggs(one box)', '200.00', NULL, '', 1, 1, 1000, '679121e575374_eggs.jpg', '2025-01-22 08:50:45', 'A');
...
(1, 'rent', 'RNT', '_car_rental.php', '', 'RENTAL', 'x', 'car-rental-icon.png', 'rent', '_car_rental.js'),
...
(6, 'shop', 'GRX', '_shop.php', '', 'Pabili', 'A', 'store.png', 'shop', ''),
(7, 'wallet', NULL, '_wallet.php', '', 'Wallet', 'X', 'wallet.png', 'wallet', ''),
...
CREATE TABLE `user_profile` (
  ...
  `user_profile_image` varchar(255) DEFAULT '/icons/female_person1.jpg',
  `rider_plate_no` varchar(10) DEFAULT NULL,
  `rider_license_no` varchar(55) DEFAULT NULL,
  `vehicle_model_id` varchar(100) DEFAULT NULL,
  `vehicle_photo_1` varchar(100) DEFAULT NULL,
  `vehicle_photo_2` varchar(100) DEFAULT NULL,
  `vehicle_photo_3` varchar(100) DEFAULT NULL,
  `vehicle_photo_4` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `user_wallet` (
  ...
  `gcash_qr` varchar(255) DEFAULT NULL COMMENT 'uploaded gcash QR'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `vehicle` (
  ...
  `vehicle_owner_id` int(4) DEFAULT 8 COMMENT 'connects to vendors.vendor_id',
  ...
  `vehicle_txn_type` int(11) NOT NULL DEFAULT 1 COMMENT '1 - active 2 - archived'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(1, '0005', 'XXX 123', 'Black', '2000 Toyota Vios', 'toyota_vios.jpg', 8, 'SMX Corporation', 'Taguig', '100.00', '2500.00', '2.00', 1),
(12, '0010', 'ABC-1234', 'Red', 'Toyota Corolla', 'toyota_corolla.jpg', 8, 'EZ Rides', 'Ligao', '10.00', '200.00', '0.50', 1),
...
--
ALTER TABLE `items_inventory`
  MODIFY `items_inventory_id` int(11) NOT NULL AUTO_INCREMENT;
